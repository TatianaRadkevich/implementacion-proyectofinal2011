...
public class PantallaFacturaConsultar extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        btnVer.setText("<html>Consultar<br>Factura<html>");
        ...
        btnAnular.setText("<html>Anular<br>Factura<html>");
    ...
    private void btnAnularActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAnularActionPerformed
        ...
        try {
            ...
            PantallaFacturaGenerar.iniciarAnularFactura(this, p.getFactura());
            btnBuscarActionPerformed(evt);
        } catch (Exception ex) {
            Mensajes.mensajeErrorGenerico(ex.getMessage());
        }
