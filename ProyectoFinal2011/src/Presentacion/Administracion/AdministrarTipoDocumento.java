 ...
 * @author Ivan
 */
public class AdministrarTipoDocumento extends javax.swing.JDialog {

    /** Creates new form AdministrarTipoDocumento */
    public AdministrarTipoDocumento(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AdministrarTipoDocumento dialog = new AdministrarTipoDocumento(new javax.swing.JFrame(), true);
