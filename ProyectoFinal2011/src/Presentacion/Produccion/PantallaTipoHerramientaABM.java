 ...
 * @author Rodrigo
 */
public class PantallaTipoHerramientaABM extends javax.swing.JDialog {

    private GestorTipoHerramienta gestor;
     private int operacion;
    private TipoHerramienta tipo_actual=null;
    /** Creates new form PantallaMaquinaHerramientaTipoABM */
    public PantallaTipoHerramientaABM(GestorTipoHerramienta g) {
        ...
        lstDisponible.getSelectionModel().addListSelectionListener(new ListSelectionListener() {
            ...
            public void valueChanged(ListSelectionEvent e) {
                if (lstDisponible.getSelectedIndex() >= 0) {
                    cargar((TipoHerramienta) lstDisponible.getSelectedValue());
                } else {
                    limpiar();
                }
            }
    ...
    public void cargarValidaciones() {
        ...
        lstDisponible.getSelectionModel().addListSelectionListener(new ListSelectionListener() {
            ...
            public void valueChanged(ListSelectionEvent e) {
                ...
                if (lstDisponible.getSelectedIndex() >= 0)
                {
                    TipoHerramienta Seleccionado = (TipoHerramienta) lstDisponible.getSelectedValue();
    ...
    public void cargarLista() {
        ...
        for (TipoHerramienta tmh : gestor.listarTipoHerramienta()) {
...
//        rdbHerramienta.setSelected(true);
    ...
    public void cargar(TipoHerramienta tmh) {
...
//        rdbMaquina.setEnabled(b);
    ...
    private void initComponents() {
        ...
        setTitle("Administrar Tipo Herramienta");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addComponent(btnNuevo, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 93, Short.MAX_VALUE)
                    .addComponent(btnBaja, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 93, Short.MAX_VALUE)
                    .addComponent(btnAlta, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 93, Short.MAX_VALUE))
                .addContainerGap())
        );
        ...
        pnlCargo.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Tipo Herramienta", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 11))); // NOI18N
    ...
    private void btnBajaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBajaActionPerformed
        ...
        tipo_actual=(TipoHerramienta) lstDisponible.getSelectedValue();
    ...
    private void btnAltaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAltaActionPerformed
        // TODO add your handling code here:
         this.activarDisponible(false);
        this.tipo_actual=(TipoHerramienta) lstDisponible.getSelectedValue();
        this.activarBaja(false);
        this.activarTipoProducto(false);
        this.activarBotones(false, false, false, true, true, false,false);
    ...
    private void lstDisponibleMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lstDisponibleMouseClicked
        // TODO add your handling code here:
         TipoHerramienta temp= (TipoHerramienta) lstDisponible.getSelectedValue();
...
private void activarTipoProducto(boolean flag){
    ...
    private void cargarDatos(TipoHerramienta tipo){
    ...
    private void vaciar(){
     ...
     private void cargarTipoProductos(){
        try {
            ...
            List<TipoHerramienta> tipo = gestor.listarTipoHerramienta();
