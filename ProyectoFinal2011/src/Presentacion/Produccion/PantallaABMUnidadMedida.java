...
public class PantallaABMUnidadMedida extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jPanel1.getAccessibleContext().setAccessibleName("Unidad de Medida");
    ...
    private void btnBajaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBajaActionPerformed
        if(lstDisponible.getSelectedIndex()==-1){
            Mensajes.mensajeErrorGenerico("Debe seleccionar una unidad de medida que desea dar de baja");
            return;
        }
    ...
    private void btnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarActionPerformed
        if(lstDisponible.getSelectedIndex()==-1){
            Mensajes.mensajeErrorGenerico("Debe seleccionar una unidad de medida que desea modificar");
            return;
        }
        this.activarDisponible(false);
        this.btnBaja.setEnabled(false);
    ...
    private void btnAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAceptarActionPerformed
        ...
        if(operacion==Operacion.baja){
            ...
            Mensajes.mensajeInformacion("La unidad de medida "+unidad_actual.getNombre()+"\n ha sido dada de baja exitosamente");
            this.vaciar();
            unidad_actual=null;
            cancelar();
            this.cargarUnidadMedida();
