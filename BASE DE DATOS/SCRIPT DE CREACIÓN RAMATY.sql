...
CREATE TABLE T_ALMACENAMIENTOS_MATERIAL (
       ID_ALMACENAMIENTO_MATERIAL numeric(10) IDENTITY,
       FEC_HORA_RECEPCION   datetime NOT NULL,
...
ALTER TABLE T_ALMACENAMIENTOS_MATERIAL
       ADD PRIMARY KEY (ID_ALMACENAMIENTO_MATERIAL ASC)
go
